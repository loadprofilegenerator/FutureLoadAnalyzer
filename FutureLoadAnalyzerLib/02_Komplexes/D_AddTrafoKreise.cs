...
namespace FutureLoadAnalyzerLib._02_Komplexes {
    ...
    public class D_AddTrafoKreise : RunableWithBenchmark {
        public D_AddTrafoKreise([NotNull] ServiceRepository services) : base(nameof(D_AddTrafoKreise), Stage.Complexes, 4, services, true)
        {
        }

        protected override void RunActualProcess()
        {
            Info("Starting to add trafoKreisInfo");
            ...
            Info("Added trafokreis data");
            Info("Added EGids: " + addedegids);
            Info("Added trafokreise: " + addedTrafoKreise + "/" + totalTrafoKreise);
        ...
        protected override void RunChartMaking()
        {
            ...
            {
                var ssa = new SingleSankeyArrow("ComplexesWithLocalnetCoords", 1000, MyStage, SequenceNumber, Name, slice, Services);

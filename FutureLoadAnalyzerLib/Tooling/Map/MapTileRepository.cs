...
namespace FutureLoadAnalyzerLib.Tooling.Map {
    public class MapTileRepository {
        ...
        [CanBeNull] [ItemNotNull] private List<Tuple<double, int>> _latdict;
        [CanBeNull] [ItemNotNull] private List<Tuple<double, int>> _longdict;
        ...
        [NotNull]
        public MapTile BoundingBoxAllFeatures { get; set; }
        ...
        {
            if (_longdict == null) {
                throw new FlaException("longdict");
            }

            if (_latdict == null) {
                throw new FlaException("latdict");
            }
        ...
        [NotNull]
        private static MapTile MakeAllFeatureBoundingBox([NotNull] [ItemNotNull] List<OsmFeature> osmFeatures)
        {

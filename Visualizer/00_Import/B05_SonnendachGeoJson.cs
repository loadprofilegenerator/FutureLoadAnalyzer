...
namespace BurgdorfStatistics._00_Import {
    ...
    public class B05_SonnendachGeoJsonLoader : RunableWithBenchmark {
        ...
        {
            SqlConnection.RecreateTable<B05_SonnendachGeoJson>(Stage.Raw, Constants.PresentSlice);
            var db = SqlConnection.GetDatabaseConnection(Stage.Raw, Constants.PresentSlice);
            const string jsonfile = "U:\\SimZukunft\\RawDataForMerging\\sonnendach8.geojson";

...
namespace BurgdorfStatistics._06_ScenarioAging {
    ...
    public class M_Industry : RunableForSingleSliceWithBenchmark {
        public M_Industry([NotNull] ServiceRepository services)
            : base(nameof(M_Industry), Stage.ScenarioCreation, 1300, services, false)
        {

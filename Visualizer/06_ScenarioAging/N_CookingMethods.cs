...
namespace BurgdorfStatistics._06_ScenarioAging {
    ...
    public class N_CookingMethods : RunableForSingleSliceWithBenchmark {
        public N_CookingMethods([NotNull] ServiceRepository services)
            : base(nameof(N_CookingMethods), Stage.ScenarioCreation, 1400, services, false)
        {
